 ...
 */
function rivendellweb_blocks_example_07_register_block() {
	...
	register_block_type( 'rivendellweb-blocks/rivendellweb-blocks-example-07', array(
...
add_action( 'init', 'rivendellweb_blocks_example_07_register_block' );
